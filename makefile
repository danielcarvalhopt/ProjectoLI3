transportes: utils.o menu.o mod_avl_n_dimensional.o mod_lista_ligada.o dados.o main.o
	gcc utils.o menu.o mod_avl_n_dimensional.o mod_lista_ligada.o dados.o main.o -o transportes
