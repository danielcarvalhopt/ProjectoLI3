...
/* Continua a pedir um número ao utilizador até que o utilizador introduza um número válido
...
/* Inicializa as variáveis static que controlam os atalhos mostrados ao utilizador com três atalhos iniciais e predefinidos
 * */
